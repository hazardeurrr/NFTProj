...
import abi from './rccontractabi';
import contract_address from './rcaddress';
import TokenGrid from './TokenGrid.jsx';
import Button from '@material-ui/core/Button';
import Card from '@material-ui/core/Card';


class Rccontract extends Component {
  constructor(props) {
    super(props)
    this.props = props
  ...
  async componentWillMount() {
      const instance = await new this.props.web3.eth.Contract(abi.abi, contract_address)
  ...
  async displayToken(){
    const instance = await new this.props.web3.eth.Contract(abi.abi, '0xA7e3B2D6b301752000a60fdFC268Aab24B62df55')
